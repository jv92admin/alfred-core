...
Core is fully domain-agnostic. It never imports any domain package. Domains implement `DomainConfig` (75 methods — 23 abstract, 52 with defaults) and call `register_domain()`.
